...
```html
    ...
    <script src="js/plugins-index-original.js"></script>
    <script src="js/index-html-original.js"></script>
</body>
```

If you like to just include the polyfills yourself, you could include them in
`js/plugins-index-original.js`. When you have a bunch of polyfills to load in, you could also
